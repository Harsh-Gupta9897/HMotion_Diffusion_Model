...
temp = torch.randn(size=(128,768,3,48))
torch.cat()
unet = MDM_UNetModel(image_size=2,in_channels=768*3
    ,model_channels= 32,
    out_channels=768*3,
    num_res_blocks= 3,
...
# #     result = kps_generate(cols,x[i])
# #     print(result)
#     renderer.render_seq(result,f"./data/demo_punet.gif")

# # input shape = n_samples, n_joints(20), n_feats(2) , n_frames(N)
